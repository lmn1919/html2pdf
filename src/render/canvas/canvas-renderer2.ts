...
import "../../Alibaba_PuHuiTi-normal"; // 导入字体
...
export class CanvasRenderer extends Renderer {
    ...
    constructor(context: Context, options: RenderConfigurations) {
        ...
        this.jspdfCtx = new jsPDF('p', 'pt', [1047, 1500]);
    ...
    renderTextWithLetterSpacing(text: TextBounds, letterSpacing: number, baseline: number): void {
        if (letterSpacing === 0) {
            ...
            this.jspdfCtx.text(text.text, text.bounds.left + extraPadding, text.bounds.top);
        } else {
            ...
            letters.reduce((left, letter) => {
                ...
                this.jspdfCtx.text(letter, left, text.bounds.top);
    ...
    async renderTextNode(text: TextContainer, styles: CSSParsedDeclaration): Promise<void> {
        ...
        this.jspdfCtx.setFontSize(styles.fontSize.number - 4);
            ...
            if (backgroundImage.type === CSSImageType.URL) {
                ...
                try {
                    ...
                    this.jspdfCtx.addImage(
                        image,
                        'JPEG',
                        container.bounds.left + x,
                        container.bounds.top + y,
                        width,
                        height
                    );
                } catch (e) {
    ...
    async renderNodeBackgroundAndBorders(paint: ElementPaint): Promise<void> {
        ...
        if (hasBackground || styles.boxShadow.length) {
            ...
            if (!isTransparent(styles.backgroundColor)) {
                ...
                this.jspdfCtx.setFillColor(color);
                this.jspdfCtx.rect(
                    paint.container.bounds.left, 
                    paint.container.bounds.top, 
                    paint.container.bounds.width, 
                    paint.container.bounds.height, 
                    'F'
                );
            }
            ...
            styles.boxShadow.forEach(shadow => {
                ...
                this.jspdfCtx.setFillColor(color);
                this.jspdfCtx.rect(
                    paint.container.bounds.left + shadow.offsetX.number,
                    paint.container.bounds.top + shadow.offsetY.number,
                    paint.container.bounds.width,
                    paint.container.bounds.height,
                    'F'
                );
        ...
        for (const border of borders) {
            if (border.style !== BORDER_STYLE.NONE && !isTransparent(border.color) && border.width > 0) {
                ...
                this.jspdfCtx.setLineWidth(border.width);
                ...
                switch(side) {
                    case 0: // top
                        this.jspdfCtx.line(
                            paint.container.bounds.left,
                            paint.container.bounds.top,
                            paint.container.bounds.left + paint.container.bounds.width,
                            paint.container.bounds.top
                        );
                        break;
                    case 1: // right
                        this.jspdfCtx.line(
                            ...
                            paint.container.bounds.top,
                            paint.container.bounds.left + paint.container.bounds.width,
                            paint.container.bounds.top + paint.container.bounds.height
                        );
                        break;
                    case 2: // bottom
                        this.jspdfCtx.line(
